...
export default function Button({handleChange, handleSubmit, ...props}) {
  return (
    <div className="relative rounded-md w-4/5 lg:w-1/2 flex mx-auto">
        <input onChange={handleChange} type="text" className="block w-full py-1.5 pr-20 hover:border-stone-300 text-[#27374D] placeholder:text-[#000] rounded-md p-2 bg-[#a1c2dc]" placeholder="Enter message..."/>
